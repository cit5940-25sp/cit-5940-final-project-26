...
public class LearningTrain {
    ...
    public TDLearningStrategy getTrainedModel() {
        // First train the naive model by playing custom vs. custom games
        try {
            this.loadTrainedModel(
                    "C:\\CIT-DSA\\othello_final_project - Copy\\othello_students\\src\\main\\java\\othello\\pretrain.zip", 0.90, 0.005);
    ...
    public static void main(String[] args) {
        ...
        training.repeatGame(200);

        try {
            training.saveTrainedModel(
                    "C:\\CIT-DSA\\othello_final_project - Copy\\othello_students\\src\\main\\java\\othello\\pretrain.zip");
        } catch (IOException exception) {
            exception.printStackTrace();
        }
