...
public class LearningTrainTest {
    ...
    @Test
    public void noTrainingCustomVsMinimaxTest() throws Exception {
        // verify it runs one iteration with no exception
        tapSystemOut(() -> lt.noTrainingCustomVsMinimax(1));
    }
